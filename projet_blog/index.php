...
<html>
    ...
    <body class="container">
      ...
      <?php
        ...
        $reponse = $bdd->query('SELECT id, titre_article, contenu_article, auteur_article, DATE_FORMAT(date_ajout, \'[%d/%m/%Y %H:%i:%s] \') AS date_ajout_fr FROM articles ORDER BY ID DESC');
         ?>
...
<?php
/*         $reponse = $bdd->query(
          'SELECT articles.id, articles.titre_article, articles.contenu_article, articles.auteur_article, commentaires.id_article,
            DATE_FORMAT(articles.date_ajout, \'[%d/%m/%Y %H:%i:%s] \') AS date_ajout_fr
            FROM articles
